"""
# adapted from https://github.com/perseids-tools/beta-code-py by Zachary Fletcher
"""
...
BETA_CODE_TO_UNICODE_MAP = json.load(open("beta_code_to_unicode.json", "r", encoding='utf-8'))
UNICODE_TO_BETA_CODE_MAP = json.load(open("unicode_to_beta_code.json", "r", encoding='utf-8'))
